    ...
    if (!$result->num_rows > 0) {
        ...
        if ($mysqli->query($createDB) === TRUE) {
            ...
            if ($mysqli->query($createTable2) === TRUE) {
                ...
                $sql7 = "INSERT INTO achievements (name, description, icon, type, level) VALUES ('You love your adding ingredients to your cauldron!','Study vocabulary for 5 days straight', 'public/img/achievements/1-Potion.gif', 'vocabulary', 'bronze')";
                $sql8 = "INSERT INTO achievements (name, description, icon, type, level) VALUES ('You love your adding ingredients to your cauldron!','Study vocabulary for 10 days straight', 'public/img/achievements/2-Potion.gif', 'vocabulary', 'silver')";
                $sql9 = "INSERT INTO achievements (name, description, icon, type, level) VALUES ('You love your adding ingredients to your cauldron!','Study vocabulary for 15 days straight', 'public/img/achievements/3-Potion.gif', 'vocabulary', 'gold')";
