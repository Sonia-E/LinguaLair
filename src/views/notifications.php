...
<link rel="stylesheet" type="text/css" href="public/css/achievements.css"/> <div class="dashboard">
    <div class="achievements"> <div class="button-group">
            <h2>Notifications</h2> </div>
        <div class="achievement-list">  <?php if (!empty($notifications)): ?>
                ...
                <div class="achievement-item">  <?php
                    ...
                    <div class="achievement-details">
                        <h4 class="achievement-title"><?php echo $notification['content']; ?></h4> 
                         <span class="achievement-date">Date: <?php echo $notification['created_at']; ?></span> <?php if (isset($notification['related_id'])): ?>
                         <?php endif; ?>
                    </div>
                </div>
                <?php endforeach; ?>
